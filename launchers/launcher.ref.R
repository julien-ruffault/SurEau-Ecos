# ### ### ### ### ### ### #s## ### ### ### ### ### ### ### ### ### ### ### ### ##
# Reference Launcher to run SurEau-ECOS on Champenoux and compute a reference output : reference.output.Champenoux.csv
...
soilParameters_path       <- paste0(mainDir,'/datasets/test_data/Soil_test_champenoux_REF.csv')
vegetationParameters_path <- paste0(mainDir,'/datasets/test_data/Parameters_test_quercus_champenoux_evergreen_REF.csv')
