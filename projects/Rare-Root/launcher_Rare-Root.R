...
#--------------------------------------------------------------------------------
# set paths
climateData_path          <- paste0(mainDir,'/projects/Rare-Root/Clim_Rustrel_2003_2020.csv')
...
output_path               <-  paste0(mainDir,'/projects/Rare-Root/Rustrel_output_subdaily.csv')
...
simulation_parameters <- create.simulation.parameters(startYearSimulation = 2014,                       
                                                      endYearSimulation = 2015,
                                                      mainDir = mainDir,
...
filename  = paste0(mainDir,"/projects/Rare-Root/Rustrel_output_subdaily.csv")
