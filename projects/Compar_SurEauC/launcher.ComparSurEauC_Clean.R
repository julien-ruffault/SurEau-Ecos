...
plot(DATA$Psi_TSym[1:24], type='b', ylab="Water potential", ylim=c(-1,0), pch=21, bg=2, xlab="Time (hour)")
points(DATARV$P_trunk_s[1:24], yaxt='n', ylab="", type='b', xaxt="n", pch=21, bg=1)
legend(0, -0.8, c("SurEau", "SurEau-Ecos"), col=c(2,1), pch=16, bty="n")
plot(dQ_TSymp_RV[1:24], typ="b", bg=2, pch=21, ylab="dQ (mmol)", ylim=c(-3000, 2000), xlab="Time (hour)")
points(dQ_Tsymp_Ecos[2:24], type='b', bg=1, pch=21)
...
E = DATA$Elim+DATA$Emin
quartz()
par(mfrow=c(2,2), mar=rep(4.1,4))
plot(E, type='l', col="dark blue", xlab="Time (hours)" , ylab= 'transpiration', ylim=c(0, 2), xlim=c(0, 2500), las=1, tck=0.02, main="SurEau-Ecos")
legend(1400, 2, c("Leaf","Trunk", "Transpiration"), col=c("dark green", "Brown", "dark blue"), cex=0.7, lty=c(1,1,1), bty="n")
par(new=T)
plot(DATA$Psi_LApo, type='l', ylab= '', xlab="",yaxt="n", ylim=c(-10, 0), col="dark green" , xlim=c(0, 2500))
lines(DATA$Psi_TApo, type='l', ylab= '',yaxt="n",  col="brown")
axis(4,las=1, tck=0.02)
mtext("water potential", 4, 1.8)
#lines(DATA$Psi_AllSoil, type='l', ylab= '',yaxt="n", ylim=c(-7, 0), col="brown")
plot(DATARV$E_Plant_m2, type='l', col="dark blue", ylab= 'transpiration', xlab="",ylim=c(0, 2), xlim=c(0, 2500), las=1, tck=0.02, main="SurEau (Cochard et al. 2021)")
par(new=T)
plot(DATARV$P_leaf_apo, type='l', col="dark green",  xlim=c(0, 2500), ylim=c(-10,0), yaxt="n", ylab="", xlab="Time (hours)")
lines(DATARV$P_trunk_a, type='l', ylab= '',yaxt="n", col="brown")
axis(4,las=1, tck=0.02)
mtext("water potential", 4, 1.8)

RWCL_ECOS=(DATA$Q_LApo_L+DATA$Q_LSym_L)/max((DATA$Q_LApo_L+DATA$Q_LSym_L))
RWCT_ECOS=(DATA$Q_TApo_L+DATA$Q_TSym_L)/max((DATA$Q_TApo_L+DATA$Q_TSym_L))

#quartz()
#par(mfrow=c(2,1), mar=rep(4.1,4))
plot(RWCL_ECOS, type='l', col="dark green", xlab="Time (hours)" , ylab= 'transpiration', ylim=c(0,1), xlim=c(0, 2500), las=1, tck=0.02)
lines(RWCT_ECOS, col="brown")
par(new=T)
plot(DATA$PLC_Leaf, type='l', ylab= '', xlab="",yaxt="n",col="dark green" , xlim=c(0, 2500))
lines(DATA$PLC_Trunk, type='l', ylab= '',yaxt="n",  col="brown")
axis(4,las=1, tck=0.02)
mtext("PLC", 4, 1.7)

#lines(DATA$Psi_AllSoil, type='l', ylab= '',yaxt="n", ylim=c(-7, 0), col="brown")
plot(DATARV$RWC_leaf, type='l', col="dark green", ylab= 'transpiration', ylim=c(0, 1), xlim=c(0, 2500), las=1, tck=0.02)
lines(DATARV$RWC_Trunk, col="brown")
par(new=T)
plot(DATARV$PLC_leaf, type='l', col="dark green",  xlim=c(0, 2500), yaxt="n", ylab="", xlab="Time (hours)")
lines(DATARV$PLC_trunk, type='l', ylab= '',yaxt="n", col="brown")
axis(4,las=1, tck=0.02)
mtext("PLC", 4, 1.7)
...
quartz()
par(mfrow=c(2,3))
plot(RV_TRB_perSoilArea, type='l', ylab="Volume TRB_L", col=2, ylim=c(0,25),xlim=c(0, 2500))
lines(ECOSTRB)
legend(0,18,c("Ecos", "RV"), col=c(1,2), lty=1, bty="n")
plot(TRB_RV_apo/1.75, type='l',ylim=c(0,17), col=2, ylab="total apo (L)",xlim=c(0, 2500))
lines(DATA$Q_TApo_L)
plot(TRB_RV_sym/1.75, type='l',ylim=c(0,10), col=2, ylab='total symp (L)',xlim=c(0, 2500))
lines(DATA$Q_TSym_L)
plot(DATARV$P_trunk_s, type='l', ylab="P trunk symp (MPa)", col=2,xlim=c(0, 2500), ylim=c(-5, 0))
lines(DATA$Psi_TSym, type='l',yaxt="n")
plot(DATARV$P_trunk_a, type='l', ylab="P trunk apo", col=2,xlim=c(0, 2500), ylim=c(-5, 0))
lines(DATA$Psi_TApo, type='l',yaxt="n")
par(new=T)
plot(DATARV$PLC_trunk, type='l',yaxt="n", ylab="", col=2,xlim=c(0, 2500), ylim=c(0,100))
...
axis(4)
mtext("PAR", 4, 1.7, cex=0.7)
plot(DATA$leafTemperature[2:25], type='b',bg=adjustcolor(1,0.3), pch=21, ylim=c(15,35), ylab="", xlab="Hours")
points(DATARV$T_leaf[1:24], type='b', pch=21, bg = adjustcolor(2, 0.4))
mtext("leaf temperature", 2, 1.8, cex=0.7)
legend(1, 36, c("SurEau", "SurEau-Ecos"), col=c(adjustcolor(2, 0.4),adjustcolor(1, 0.4)), pch=16, bty="n", cex=0.7)

plot(DATA$leafVPD[2:25], type='b',bg=adjustcolor(1,0.3), pch=21, ylab="Leaf VPD", xlab="Hours")
lines(DATARV$VPD_Leaf[1:24], type='b', pch=21, bg = adjustcolor(2, 0.4))

plot(DATA$Elim[2:25]-DATA$Emin[2:25], type='b',bg=adjustcolor(1,0.3), pch=21,  ylim=c(0,1.3), ylab="E stomata")
lines(DATARV$E_stomata[1:24]-DATARV$E_cuti_m2[1:48], type='b', pch=21, bg = adjustcolor(2, 0.4))

plot(DATA$Emin[2:25], type='b', bg=adjustcolor(1,0.3), pch=21, ylab="E leaf cuti", xlab="Hours", ylim=c(0,0.15))
lines(DATARV$E_cuti_m2[1:24], type='b', pch=21, bg = adjustcolor(2, 0.4))

plot(DATA$Psi_TSym[2:24], type='b', bg=adjustcolor(1, 0.4), ylim=c(-2,0), pch=21,  xlab="hours", ylab="Trunk symp. water potential")
lines(DATARV$P_trunk_s[1:24], type='b', bg=adjustcolor(2, 0.4), pch=21)
plot(DATA$Psi_TApo[2:24], type='b', bg=adjustcolor(1, 0.4), ylim=c(-2,0), main="", pch=21,  xlab="hours", ylab="Trunk apo water potential")
lines(DATARV$P_trunk_a[1:24], type='b',  bg=adjustcolor(2, 0.4), pch=21)
plot(DATA$Psi_LApo[2:24], type='b', bg=adjustcolor(1, 0.4), main="", ylim=c(-2,0), pch=21,  xlab="hours", ylab="Leaf apo water potential")
lines(DATARV$P_leaf_apo[1:24], type='b', bg=adjustcolor(2, 0.4), pch=21)
plot(DATA$Psi_LSym[2:24], type='b',  bg=adjustcolor(1, 0.4), main="", ylim=c(-2,0), pch=21,  xlab="hours", ylab="Leaf symp. water potential")
lines(DATARV$P_leaf_sym[1:24], type='b',  bg=adjustcolor(2, 0.4), pch=21)
#--------------------------
...
# quartz()
# par(mfrow=c(2,2), las=1, tck=0.02)
