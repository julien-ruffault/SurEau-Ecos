...
params=c('P50_VC_Leaf','delta_P50_P88gs','kPlantInit','gsMax','gmin20','VolumeLiving_TRB')
#
...
PARAMS[, "delta_P50_P88gs"] <- qunif(PARAMS[, "delta_P50_P88gs"],(vegFile$P50_VC_Leaf-vegFile$P88_gs)+ 0.5*(vegFile$P50_VC_Leaf-vegFile$P88_gs), vegFile$P50_VC_Leaf-vegFile$P88_gs- 0.5*(vegFile$P50_VC_Leaf-vegFile$P88_gs))
#PARAMS[, "delta_P_gs"] <- qunif(PARAMS[, "delta_P_gs"],(vegFile$P88_gs-vegFile$P12_gs)+ 0.5*(vegFile$P88_gs-vegFile$P12_gs), vegFile$P88_gs-vegFile$P12_gs- 0.5*(vegFile$P88_gs-vegFile$P12_gs))
...
foreach(i=1:nrow(PARAMS),.packages=c('lubridate','insol')) %dopar% {
  ...
  vegFile$P88_gs = vegFile$P50_VC_Leaf-PARAMS[,"delta_P50_P88gs"][i]
  vegFile$P12_gs = vegFile$P88_gs+0.55
