...
#--------------------------------------------------------------------------------
# set paths
climateData_path          <- paste0(mainDir,'/projects/PapierMyriam/Climat/Puechabon/Climat_Puechabon_site.csv')
...
output_path               <-  paste0(mainDir,'/projects/PapierMyriam/Output_Qilex_PapierMyriam_Climat_Puechabon.csv')
...
filenameQilClimPuech  = paste0(mainDir,"/Projects/PapierMyriam/Output_Qilex_PapierMyriam_Climat_Puechabon.csv")
